...
Ссылки здесь — запасной вариант: tiktokenizer и TokenProbe встроены в занятие прямо в embed-слайдах 5 и 11.
...
- **tiktokenizer** — токенизатор вживую: вставь текст, увидишь, как он разбивается на токены и какие
  ...
  (embed-слайд 5; упоминается в слайде 9):
...
- Программа-сценарий Manim-ролика «Узкое горлышко против матрицы внимания» — `videos/manim/06-rnn-i-transformer.py`
  (запуск и описание — `videos/README.md`).
