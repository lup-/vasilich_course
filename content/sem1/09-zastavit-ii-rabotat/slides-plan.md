...
«Ох, деточка, представь: в цех пришёл новый сотрудник — толковый, но опыта ноль. Скажешь ему: „напиши
...
- **Содержание:**
  - `task` (Markdown): «Так, молодежь, без воды! Разбери сырую накладную в таблицу.
...
- **Назначение:** сквозная тема — проверка результата: правильный ответ «зарыт» в длинной инструкции.
- **Содержание:**
...
- **Содержание:**
  - `task` (Markdown): «Не тяни резину! Собери дежурного по инструкциям и проверь его на деле.
