...
«Ох, деточка, представь: бригадир велел смене: „Читайте накладную вслух“. А в накладной кто-то дописал:
...
«А вот ещё хитрее, деточка. Если чужой приказ подмешали не в твой запрос, а в **документ или сайт**, который модель читает по
...
- **Содержание:**
  - `task` (Markdown): «Чего сидишь, молодежь! Поставь защиту и проверь — без воды!
...
- **Назначение:** сквозная тема — проверка: не доверяй ИИ на слово.
- **Содержание:**
  ...
  - `description`: «„Знаете, когда доверяешь человеку какой-нибудь секрет и просишь никому не говорить…“
    — а он разболтал. Твою ж изоленту! Дежурного у нас тоже „разболтал“ шутник со смены: словами вытащил пароль — и бухгалтерия
