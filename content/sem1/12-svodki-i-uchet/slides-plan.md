...
«Самая частая команда, деточка, прям рил: **посчитай по группам**. „По каждому региону“, „по месяцу“,
...
Решения о пропусках принимаешь ты, солнышко: для суммы пропуск — это 0, для среднего возраста — уже нет. Без б.
