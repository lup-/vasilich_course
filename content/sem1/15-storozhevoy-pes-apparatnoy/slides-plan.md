...
«Логи цеха, деточка, лежат в Excel — ещё один склад, без б. Открываем, как любой другой:
...
«Сторож, деточка, — это конвейер, имба-штука: сырьё на входе, готовый продукт на выходе.
...
- **Содержание:**
  ...
  - `image_url`: `memes/images/m00655.jpg` (кандидат; картинку проверяет человек глазами — по правилам
    курса)
  - `description`: «Таблица от 0 до 9, а единицу тихо сожрали — и все кивают. Как в журнале датчиков: пропуск не видно, пока сторож не ткнёт носом.»
