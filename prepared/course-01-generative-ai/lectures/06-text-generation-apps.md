...
<!-- изображение (не скопировано): Создание приложений для генерации текста (ссылка: https://youtu.be/0Y5Luf5sRQA?si=t_xVg0clnAI4oUFZ) -->
...
<!-- изображение (не скопировано): Keys and Endpoint resource blade in Azure Portal -->
