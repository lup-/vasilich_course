...
<!-- изображение (не скопировано): Введение в генеративный ИИ и большие языковые модели (ссылка: https://youtu.be/W0-nzXjOjr0?si=GcsqiTTvd7RKbo7V) -->
...
<!-- изображение (не скопировано): Семантический запрос для вопроса "Можно ли использовать rstudio с Azure ML" -->
...
<!-- изображение (не скопировано): Поле ввода для ввода запроса пользователем -->
