...
<!-- изображение (не скопировано): Создание приложений для генерации изображений (ссылка: https://youtu.be/B5VP0_J7cs8?si=5P3L5o7F_uS_QcG9) -->
...
<!-- изображение (не скопировано): Стартап Edu4All, класс, памятники, Эйфелева башня -->
...
<!-- изображение (не скопировано): Изображение, сгенерированное Midjourney, механический голубь -->
...
<!-- изображение (не скопировано): Заяц на лошади с леденцом, версия 1 -->

Теперь выполним тот же самый промпт еще раз, чтобы увидеть, что изображения не будут совпадать:

<!-- изображение (не скопировано): Сгенерированное изображение зайца на лошади -->
...
- <!-- изображение (не скопировано): Температура 0, версия 1 -->
- <!-- изображение (не скопировано): Температура 0, версия 2 -->
