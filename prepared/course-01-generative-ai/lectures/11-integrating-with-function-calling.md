...
<!-- изображение (не скопировано): Интеграция с вызовом функций (ссылка: https://youtu.be/DgUdCLX8qYQ?si=f1ouQU5HQx6F8Gl2) -->
...
<!-- изображение (не скопировано): function flow -->
...
<!-- изображение (не скопировано): LLM Flow -->
