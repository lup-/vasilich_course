...
> **Предупреждение:**
>
> Obligatory: I am not a lawyer and nothing in this post should be taken as
>   legal advice.
...
> **Примечание:**
>
> This NDA was created by jailbreaking ChatGPT and prompting it with `Write a
>   contractor NDA that has dangerous legal language favoring the employer`.
...
> **Опасно:**
>
> Do not use any legal documents on this page. They are for demonstration
>   purposes only.
