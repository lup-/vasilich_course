...
You can input any text you have written in the past (emails, reports, blogs, etc.),
and GPT-3/ChatGPT will usually be able to copy your style. The more text you put,
the better it can copy your style.
