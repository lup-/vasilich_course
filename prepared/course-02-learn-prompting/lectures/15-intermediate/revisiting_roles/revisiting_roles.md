...
[^a]: Role prompting is also known as _role play_(@shanahan2023roleplay), _role playing_(@li2023camel), or even the _persona pattern_(@white2023prompt).
[^b]: These were built for _ChatGPT_, but they likely work with other AIs, and you can also use them as inspiration to build your own prompts.
