...
> Связанные лекции: [Лекция 01. Сильные модели не означают надёжного выполнения](./../lectures/lecture-01-why-capable-agents-still-fail.md) · [Лекция 02. Что на самом деле такое harness](./../lectures/lecture-02-what-a-harness-actually-is.md)
