...
> Связанные лекции: [Лекция 03. Сделайте репозиторий единственным источником истины](./../lectures/lecture-03-why-the-repository-must-become-the-system-of-record.md) · [Лекция 04. Разделите инструкции по файлам](./../lectures/lecture-04-why-one-giant-instruction-file-fails.md)
