...
> Связанные лекции: [Лекция 05. Сохраняйте контекст живым между сессиями](./../lectures/lecture-05-why-long-running-tasks-lose-continuity.md) · [Лекция 06. Инициализируйте перед каждой сессией агента](./../lectures/lecture-06-why-initialization-needs-its-own-phase.md)
