...
> Связанные лекции: [Лекция 07. Чётко обозначьте границы задач для агентов](./../lectures/lecture-07-why-agents-overreach-and-under-finish.md) · [Лекция 08. Используйте списки фич, чтобы ограничивать действия агента](./../lectures/lecture-08-why-feature-lists-are-harness-primitives.md)
