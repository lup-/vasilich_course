...
> Связанные лекции: [Лекция 09. Не давайте агентам объявлять победу слишком рано](./../lectures/lecture-09-why-agents-declare-victory-too-early.md) · [Лекция 10. Только полный прогон пайплайна считается настоящей верификацией](./../lectures/lecture-10-why-end-to-end-testing-changes-results.md)
