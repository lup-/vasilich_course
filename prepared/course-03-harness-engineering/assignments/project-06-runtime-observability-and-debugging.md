...
> Связанные лекции: [Лекция 11. Сделайте runtime агента наблюдаемым](./../lectures/lecture-11-why-observability-belongs-inside-the-harness.md) · [Лекция 12. Чистый handoff в конце каждой сессии](./../lectures/lecture-12-why-every-session-must-leave-a-clean-state.md)
